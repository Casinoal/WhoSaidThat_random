...
import apps.arw.whosaidthatexpansion.R;
...
public class MainActivity extends Activity {
 ...
 protected void onCreate(Bundle savedInstanceState) {
  ...
  setContentView(R.layout.activitysquares);

  hi = MediaPlayer.create(this, R.raw.welcomewho);
  hi.start();
 ...
 private void showScene() {
	 ...
	 if(hi.isPlaying())
	 {
	     ...
	     hi.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
 ...
 private void populatePool(int quantity) {
	  ...
	  poolOfImagesAndSounds.add(new ImageSoundItem("horse", "horse"
			  ));
	  ...
	  poolOfImagesAndSounds.add(new ImageSoundItem("bird", "bird"
			  ));
